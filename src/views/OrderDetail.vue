<template>
  <div class="order-detail">
    <div class="container">
      <div class="head">
        <div class="title f-b">
          <h3>Đơn hàng số #{{ order[0].orderId }}</h3>
        </div>
        <div class="time">
      ...
      <div class="content">
        ...
        <div class="main">
          <table width="100%">
            ...
            <tr v-for="(product, index) in order" :key="product.productId">
              <td>
                {{ index + 1 }}
              </td>
              <td>
            ...
            <tr>
              ...
              <td colspan="1">
                <span class="f-b">{{ formatMoney(order[0].totalAmount) }}</span>
                VND
              </td>
            </tr>
          </table>
...
export default {
  ...
  computed: {
    ...mapGetters("orderDetail", { order: "getOrder" })
  },
  methods: {
